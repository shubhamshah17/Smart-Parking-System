...
public class parkingTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(parkingTwo.this, R.style.MyAlertDialogStyle);
        ...
        slot1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toasty.info(parkingTwo.this,"SLOT 1",Toasty.LENGTH_SHORT,false).show();
            }
        });
        slot2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toasty.info(parkingTwo.this,"SLOT 2",Toasty.LENGTH_SHORT,false).show();
            }
        });
        slot3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toasty.info(parkingTwo.this,"SLOT 3",Toasty.LENGTH_LONG,false).show();
            }
        });
        slot4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toasty.info(parkingTwo.this,"SLOT 4",Toasty.LENGTH_SHORT,false).show();
            }
        });
        slot5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toasty.info(parkingTwo.this,"SLOT 5",Toasty.LENGTH_SHORT,false).show();
            }
        });
        slot6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toasty.info(parkingTwo.this,"SLOT 6",Toasty.LENGTH_SHORT,false).show();
            }
        });
        slot7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toasty.info(parkingTwo.this,"SLOT 7",Toasty.LENGTH_SHORT,false).show();
            }
        });
        slot8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toasty.info(parkingTwo.this,"SLOT 8",Toasty.LENGTH_SHORT,false).show();
            }
        });
        slot9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toasty.info(parkingTwo.this,"SLOT 9",Toasty.LENGTH_SHORT,false).show();
            }
        });
        slot10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toasty.info(parkingTwo.this,"SLOT 10",Toasty.LENGTH_SHORT,false).show();
            }
        });
